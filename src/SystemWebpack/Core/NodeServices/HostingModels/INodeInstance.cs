...
namespace SystemWebpack.Core.NodeServices.HostingModels {
    ...
    public interface INodeInstance : IDisposable {
        ...
        ///     The path to the Node.js module (i.e., JavaScript file) relative to your project root that
        ///     contains the code to be invoked.
        /// </param>
        /// <param name="exportNameOrNull">
        ///     If set, specifies the CommonJS export to be invoked. If not set, the module's default
        ///     CommonJS export itself must be a function to be invoked.
        /// </param>
        ...
        Task<T> InvokeExportAsync<T>(CancellationToken cancellationToken, string moduleName, string exportNameOrNull,
            params object[] args);
    }
}