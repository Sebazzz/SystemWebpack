...
namespace SystemWebpack.Core.NodeServices.HostingModels {
    ...
    public interface INodeServices : IDisposable {
        ...
        ///     The path to the Node.js module (i.e., JavaScript file) relative to your project root whose
        ///     default CommonJS export is the function to be invoked.
        /// </param>
        ...
        /// <param name="args">Any sequence of JSON-serializable arguments to be passed to the Node.js function.</param>
        /// <returns>A <see cref="Task{TResult}" /> representing the completion of the RPC call.</returns>
        Task<T> InvokeExportAsync<T>(CancellationToken cancellationToken, string moduleName,
            string exportedFunctionName, params object[] args);
    }
}