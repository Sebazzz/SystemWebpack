...
// 
//  File:           : NodeInvocationException.cs
...
namespace SystemWebpack.Core.NodeServices.HostingModels {
    ...
    public class NodeInvocationException : Exception {
        ...
        public NodeInvocationException(string message, string details, bool nodeInstanceUnavailable,
            ...
            this.NodeInstanceUnavailable = nodeInstanceUnavailable;
            this.AllowConnectionDraining = allowConnectionDraining;
        }
