...
$UseExperimental = "";
if($Experimental.IsPresent -and !($Mono.IsPresent) -or $true) {
...
if(-Not $SkipToolPackageRestore.IsPresent) {
	...
	$Expr = "&`"$NUGET_EXE`" install -FallbackSource http://cvs.becogroep.net:100/nuget -ExcludeVersion -OutputDirectory `"$TOOLS_PACKAGES_DIR`""
	Write-Verbose $Expr
